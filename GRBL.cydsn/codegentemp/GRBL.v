// ======================================================================
// GRBL.v generated from TopDesign.cysch
// 04/29/2019 at 21:36
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=true, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=200, CompareValue2=200, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=7999, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=Servo_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Servo_PWM, CY_INSTANCE_SHORT_NAME=Servo_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Servo_PWM, )
module PWM_v3_30_4 (
    reset,
    clock,
    tc,
...
module top ;
	...
	wire [5:0] tmpOE__Limit_Pins_net;
	wire [5:0] tmpFB_5__Limit_Pins_net;
	wire [5:0] tmpIO_5__Limit_Pins_net;
	electrical [0:0] tmpSIOVREF__Limit_Pins_net;

	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  .drive_mode(18'b010_001_010_001_010_110),
		  .ibuf_enabled(6'b1_1_1_1_1_1),
		  .init_dr_st(6'b1_0_1_0_1_0),
		  .input_clk_en(0),
		  .input_sync(6'b0_0_0_0_0_1),
		  .input_sync_mode(6'b0_0_0_0_0_0),
		  .intr_mode(12'b10_00_10_00_10_00),
		  .invert_in_clock(0),
		  .invert_in_clock_en(0),
		  .invert_in_reset(0),
		  .invert_out_clock(0),
		...
		Limit_Pins
		 (.oe(tmpOE__Limit_Pins_net),
		  .y({6'b0}),
		  .fb({tmpFB_5__Limit_Pins_net[5:0]}),
		  .io({tmpIO_5__Limit_Pins_net[5:0]}),
		  .siovref(tmpSIOVREF__Limit_Pins_net),
		  .interrupt({Net_410}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Limit_Pins_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};

	wire [5:0] tmpOE__Control_Pins_net;
	wire [5:0] tmpFB_5__Control_Pins_net;
	wire [5:0] tmpIO_5__Control_Pins_net;
	electrical [0:0] tmpSIOVREF__Control_Pins_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("68c14227-bc95-4bc1-9644-45ccc66d449e"),
		  ...
		  .input_sync_mode(6'b0_0_0_0_0_0),
		  .intr_mode(12'b00_00_00_10_10_10),
		  .invert_in_clock(0),
		  .invert_in_clock_en(0),
		  .invert_in_reset(0),
		  .invert_out_clock(0),
		  ...
		  .input_buffer_sel(12'b00_00_00_00_00_00))
		Control_Pins
		 (.oe(tmpOE__Control_Pins_net),
		  .y({6'b0}),
		  .fb({tmpFB_5__Control_Pins_net[5:0]}),
		  .io({tmpIO_5__Control_Pins_net[5:0]}),
		  .siovref(tmpSIOVREF__Control_Pins_net),
		  .interrupt({Net_409}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Control_Pins_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};
	...
	wire [0:0] tmpOE__Debug_Red_Pin_net;
	wire [0:0] tmpFB_0__Debug_Red_Pin_net;
	wire [0:0] tmpIO_0__Debug_Red_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Debug_Red_Pin_net;
	electrical [0:0] tmpSIOVREF__Debug_Red_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("73341a8e-7354-44ba-8cba-da88f4ca3ba8"),
		  ...
		  .input_buffer_sel(2'b00))
		Debug_Red_Pin
		 (.oe(tmpOE__Debug_Red_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Debug_Red_Pin_net[0:0]}),
		  .io({tmpIO_0__Debug_Red_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Debug_Red_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Debug_Red_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Debug_Red_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam Control_Reg_Step.NumOutputs = 2;

	wire [0:0] tmpOE__Pin_Direction_Z_net;
	wire [0:0] tmpFB_0__Pin_Direction_Z_net;
	wire [0:0] tmpIO_0__Pin_Direction_Z_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Direction_Z_net;
	electrical [0:0] tmpSIOVREF__Pin_Direction_Z_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ffd53ab4-f853-49e0-b32f-b96b89ff6c37"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Direction_Z
		 (.oe(tmpOE__Pin_Direction_Z_net),
		  .y({Net_1799}),
		  .fb({tmpFB_0__Pin_Direction_Z_net[0:0]}),
		  .io({tmpIO_0__Pin_Direction_Z_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Direction_Z_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Direction_Z_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Direction_Z_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyControlReg_v1_80 Control_Reg_Direction (
        .control_1(Net_994),
        .control_2(Net_1386),
        .control_3(Net_1372),
        .control_0(Net_997),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Control_Reg_Direction.Bit0Mode = 0;
    defparam Control_Reg_Direction.Bit1Mode = 0;
    defparam Control_Reg_Direction.Bit2Mode = 0;
    defparam Control_Reg_Direction.Bit3Mode = 0;
    defparam Control_Reg_Direction.Bit4Mode = 0;
    defparam Control_Reg_Direction.Bit5Mode = 0;
    defparam Control_Reg_Direction.Bit6Mode = 0;
    defparam Control_Reg_Direction.Bit7Mode = 0;
    defparam Control_Reg_Direction.BitValue = 0;
    defparam Control_Reg_Direction.BusDisplay = 0;
    defparam Control_Reg_Direction.ExtrReset = 0;
    defparam Control_Reg_Direction.NumOutputs = 2;

	wire [0:0] tmpOE__Pin_Direction_X_net;
	wire [0:0] tmpFB_0__Pin_Direction_X_net;
	wire [0:0] tmpIO_0__Pin_Direction_X_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Direction_X_net;
	electrical [0:0] tmpSIOVREF__Pin_Direction_X_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0f1415f4-ed09-4063-8151-e150217d8ea6"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Direction_X
		 (.oe(tmpOE__Pin_Direction_X_net),
		  .y({Net_997}),
		  .fb({tmpFB_0__Pin_Direction_X_net[0:0]}),
		  .io({tmpIO_0__Pin_Direction_X_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Direction_X_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Direction_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Direction_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Direction_Y_net;
	wire [0:0] tmpFB_0__Pin_Direction_Y_net;
	wire [0:0] tmpIO_0__Pin_Direction_Y_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Direction_Y_net;
	electrical [0:0] tmpSIOVREF__Pin_Direction_Y_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("82d0d2f0-356d-4c44-944e-b746c30a583e"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Direction_Y
		 (.oe(tmpOE__Pin_Direction_Y_net),
		  .y({Net_994}),
		  .fb({tmpFB_0__Pin_Direction_Y_net[0:0]}),
		  .io({tmpIO_0__Pin_Direction_Y_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Direction_Y_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Direction_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Direction_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__BLE_Status_Pin_net;
	wire [0:0] tmpFB_0__BLE_Status_Pin_net;
	wire [0:0] tmpIO_0__BLE_Status_Pin_net;
	wire [0:0] tmpINTERRUPT_0__BLE_Status_Pin_net;
	electrical [0:0] tmpSIOVREF__BLE_Status_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("fe1cdd76-dc47-454f-94c0-faabf5acb447"),
		  ...
		  .input_buffer_sel(2'b00))
		BLE_Status_Pin
		 (.oe(tmpOE__BLE_Status_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BLE_Status_Pin_net[0:0]}),
		  .io({tmpIO_0__BLE_Status_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__BLE_Status_Pin_net),
		  .interrupt({tmpINTERRUPT_0__BLE_Status_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BLE_Status_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
